 ...
 */
public class SearchByAvailability extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Search By Dealer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchByAvailability.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchByAvailability().setVisible(true);
            }
        });
    }
