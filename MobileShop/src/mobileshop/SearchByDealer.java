 ...
 */
public class SearchByDealer extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        SearchByBrand eh = new SearchByBrand();
        eh.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchByDealer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchByDealer().setVisible(true);
            }
        });
    }
    ...
    private void GetTableData() {
        ...
        try {
            String sql = "Select ProductId, EntryDate, DealerName, Brand, Model, CategoryName, Description, ManufactureDate, Price, Availble, Quantity FROM PRODUCT_INFO order by DealerName";
