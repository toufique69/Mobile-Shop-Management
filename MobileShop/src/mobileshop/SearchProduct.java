...
public class SearchProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Search By Dealer");
    ...
    private void backbutton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backbutton1ActionPerformed
        ...
        if(Login.LoginAs == 0)
        {
            ProductInfo ah = new ProductInfo();
            ah.setVisible(true);
            this.dispose();
        }
    ...
    private void GetTableData() {
        ...
        try {
            String sql = "Select ProductId, EntryDate, DealerName, Brand, Model, CategoryName, Description, ManufactureDate, Price, Availble, Quantity FROM PRODUCT_INFO";
