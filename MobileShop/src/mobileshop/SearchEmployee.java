...
public class SearchEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        admintable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EmployeeId", "EmployeeName", "UserName", "UserPass", "Gender", "Designation", "PhoneNo", "Address", "Salary", "JoinDate"
            }
        ));
    ...
    private void backbutton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backbutton1ActionPerformed
        // TODO add your handling code here:
            EmployeeInfo ah = new EmployeeInfo();
            ah.setVisible(true);
            this.dispose();
    ...
    private void GetTableData() {
        ...
        try {
            String sql = "Select EmployeeId, EmployeeName, Gender, Designation, PhoneNo, Address, JoinDate FROM EMPLOYEE_INFO order by EmployeeId";
